...
def merge():
    ...
    df_list=[etoto_scraper(etoto),fuksiarz_scraper(fuksiarz),totalbet_scraper(totalbet),betfan_scraper(betfan),api_betclick_scraper(betclick)]
    columns_suffix_list=['etoto','fuksiarz','totalbet','betfan','betclick']
